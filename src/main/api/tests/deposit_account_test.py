...
class TestDepositAccount:    
    ...
    def test_deposit_account(self,api_manager:ApiManager, create_account_deposit:DepositFixture):
       ...
       response_get_transactions:GetAccountTransactionsResponse = api_manager.get_transactions_steps.get_transactions(response_deposit.id, create_account_deposit.user)
       assert  response_deposit.balance == response_get_transactions.balance
